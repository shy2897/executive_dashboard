...
class FilteredUSDInOutFlowChart extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        $inflow_start = Trend::query(Operation::where('description', 'USD Inflow (in million)'))
        ->dateColumn('date')
        ->between(
            start: $startStart,
            end: $endStart,
        ...
        $inflow_end = Trend::query(Operation::where('description', 'USD Inflow (in million)'))
        ->dateColumn('date')
        ->between(
            start: $startEnd,
            end: $endEnd,
        ...
        $outflow_start = Trend::query(Operation::where('description', 'USD Outflow (in million)'))
        ->dateColumn('date')
        ->between(
            start: $startStart,
            end: $endStart,
        ...
        $outflow_end = Trend::query(Operation::where('description', 'USD Outflow (in million)'))
        ->dateColumn('date')
        ->between(
            start: $startEnd,
            end: $endEnd,
